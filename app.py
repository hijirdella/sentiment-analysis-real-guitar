...
model = joblib.load('RidgeClassifier - Real Guitar.pkl')
vectorizer = joblib.load('tfidf_vectorizer_Real Guitar.pkl')
label_encoder = joblib.load('label_encoder_Real Guitar.pkl')

# --- Judul App ---
st.title("🎸 Sentiment Analysis - Real Guitar App")
    ...
    if st.button("Prediksi Sentimen"):
        if user_review.strip() == "":
            ...
            st.download_button(
                ...
                data=csv_manual,
                file_name="manual_review_prediction_real_guitar.csv",
                mime="text/csv"
            )
        ...
        try:
            ...
            if 'review' not in df.columns:
                ...
                st.download_button(
                    ...
                    data=csv_result,
                    file_name="predicted_reviews_real_guitar.csv",
                    mime="text/csv"
                )
